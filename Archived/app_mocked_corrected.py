...
# --- Folder Upload (Support Files) ---
st.header("📂 Step 2: (Optional) Load Supporting Files from Folder")

folder_reqs = []
folder_path = st.text_input("📁 Enter the folder path to scan for documents (txt, pdf, docx, etc.):")
